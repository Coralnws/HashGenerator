// src/lib.rs
/*
 * Core library for HashGenerator
 */
...
#[derive(Debug)]
pub struct HashGeneratorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HashGeneratorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HashGenerator processing");
    
    let mut processor = HashGeneratorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HashGeneratorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HashGeneratorProcessor::new(false);
